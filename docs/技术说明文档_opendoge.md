...
| 地形模型 | section01/02/03C/V | 更新为0126/0131/0202版本 | 使用最新版本的地形碰撞和视觉模型 |
...
| wp_2-8_body | (0.3, 16.2, 1.8) | Section02过渡点 |
| wp_2-12_body | (-0.2, 18.0, 1.3) | Section02过渡点 |
| wp_2-10_body | (-2.0, 17.8, 1.3) | Section02过渡点 |
| wp_2-5-1_body | (-0.3, 20.2, 1.8) | Section02奖励点1 |
| wp_2-5_body | (0.3, 19.7, 1.8) | Section02奖励点2 |
