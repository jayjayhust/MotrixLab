...
uv run scripts/play.py --env vbot_navigation_section001 --num-envs 10 --policy runs/vbot_navigation_section001/26-02-06_08-40-45-310915_PPO/checkpoints/best_agent.pickle
```
